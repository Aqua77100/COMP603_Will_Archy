...
public class Panel extends JPanel implements KeyListener, ComponentListener {
    ...
    RepairShop repairShop = new RepairShop(500, 500);
    String message = "";
    ...
    public void paint(Graphics g)
    {
        ...
        g.drawString("This is an example " + message, example.x, example.y);
        ...
        g.drawString("Total Number of Threads: "+Thread.activeCount(), 5, 20);
        repaint();
    }
